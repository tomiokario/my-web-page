...
- [Issue 検証ループ](./issue-validation-loop.md) - 小さな題材で AI 開発ループを固める手順と、role 境界・対外コメント・上位制約との衝突時の扱い
- [repo ローカル agent 定義](../../.codex/agents/README.md) - 質問担当 / 実装担当 / fresh review 担当 / intent review 担当の再利用用定義と情報境界

...
- 質問フェーズは Human-in-the-loop、合意済み Issue の実装は Human-out-of-the-loop、PR 上の最終確認は Human-on-the-loop として扱います
- 合意済み Issue の実装では、仕様の抜けや高リスクな分岐がない限り追加質問なしで実装・検証・fresh review まで進めます

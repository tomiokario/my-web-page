...
- 各作業スレッドは 1 Issue だけを担当し、自分の worktree、ブランチ、差分、検証、Pull Request、merge 後の後片付けを扱う
...
10. 人間から merge 完了の連絡を受けたら、各作業スレッドに自分の worktree とブランチを後片付けさせ、完了状態を集約する
